...
TEST_RESULTS=${RESULTS}test/tight/mst/
...
python run_baseline.py -e ${TMPDIR}/events.csv -t ${TMPDIR}/telescopes.csv -c ${TEST_RESULTS}hillas.csv -o ${TEST_RESULTS}results.csv -f ${TMPDIR} -r ${TRAIN_RESULTS}energy_regressor.pickle -T MST_FlashCam 
