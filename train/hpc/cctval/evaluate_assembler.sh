...
#SBATCH -o output_assemblers_%j.log
#SBATCH -e error_assemblers_%j.log
#SBATCH --gres=gpu:2
#SBATCH --time=7-0
...
echo "BMO Assembler"
python evaluate.py --assembler ./config/cctval/alt_az/baseline/bmo_assembler.json --all --samples --predictions --results
